...
def main(
    ...
    critics = [
        OracleCritic.from_pretrained(
            str(root_dir.joinpath("models/electrolyte-solvent")),
            limits={"bp": (75, None), "mp": (None, 0)},
            model_cls=MISTMultiTask,
        ),
        OracleCritic.from_pretrained(
    ...
    with torch.autograd.profiler.emit_nvtx():
        dump_to_sqlite_threaded(
            generate(
                fabric, critics, "./frag_extend.smi.frag", encoding="smiles-kekule"
            ),
