...
// TODO: Include all benchmarks from MolecularNet
{
  ...
  qm8: {
    ...
    target_columns: [
      ...
      'E2-CC2-RI-CC2/def2TZVP',
      'f1-CC2-RI-CC2/def2TZVP',
      'f2-CC2-RI-CC2/def2TZVP',
      'E1-PBE0-LR-TDPBE0/def2SVP',
      'E2-PBE0-LR-TDPBE0/def2SVP',
      'f1-PBE0-LR-TDPBE0/def2SVP',
      'f2-PBE0-LR-TDPBE0/def2SVP',
      'E1-PBE0-LR-TDPBE0/def2TZVP',
      'E2-PBE0-LR-TDPBE0/def2TZVP',
      'f1-PBE0-LR-TDPBE0/def2TZVP',
      'f2-PBE0-LR-TDPBE0/def2TZVP',
      'E1-CAM-LR-TDCAM-B3LYP/def2TZVP',
      'E2-CAM-LR-TDCAM-B3LYP/def2TZVP',
      'f1-CAM-LR-TDCAM-B3LYP/def2TZVP',
      'f2-CAM-LR-TDCAM-B3LYP/def2TZVP',
    ],
  },
  qm9: {
    task: 'regression',
